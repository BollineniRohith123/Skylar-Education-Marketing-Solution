...
export const transformUserImage = async (
  ...
  try {
    ...
    const fullPrompt = `Edit this image: ${promptInstruction}. Ensure the person's face remains recognizable but transform their outfit and background to match the description. High quality, photorealistic, 8k.`;
